...
import { 
  ...
  Download, Trash2, CheckCircle, Smartphone, LogOut, QrCode
} from 'lucide-react'
...
export default function SettingsModal({ onClose }: SettingsComponentProps) {
  ...
  const loadBlockedUsers = async () => {
    ...
    try {
      ...
      if (blockedIds.length > 0) {
        ...
        if (profiles) {
          setBlockedUsers(profiles.map((p: any) => ({
            id: p.id,
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4 animate-fade-in">
      <div className="bg-white rounded-2xl sm:rounded-3xl w-full max-w-6xl h-[90vh] sm:h-[85vh] overflow-hidden flex flex-col sm:flex-row relative shadow-elevated border border-gray-100 animate-fade-in-scale">
        ...
        <div className="flex-1 h-full overflow-y-auto p-4 sm:p-6 md:p-8">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex gap-2">
                        <label className="px-4 py-2 bg-gradient-to-r from-primary-500 to-accent-indigo text-white rounded-xl hover:from-primary-600 hover:to-primary-700 shadow-md shadow-primary-500/20 hover:shadow-lg transition-all duration-200 cursor-pointer transition-colors inline-block">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <button 
                    className="px-4 py-2 bg-gradient-to-r from-primary-500 to-accent-indigo text-white rounded-xl hover:from-primary-600 hover:to-primary-700 shadow-md shadow-primary-500/20 hover:shadow-lg transition-all duration-200 disabled:bg-gray-300"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <button 
                    className="px-4 py-2 bg-gradient-to-r from-primary-500 to-accent-indigo text-white rounded-xl hover:from-primary-600 hover:to-primary-700 shadow-md shadow-primary-500/20 hover:shadow-lg transition-all duration-200 disabled:bg-gray-300 flex items-center gap-2"
          ...
          {changePasswordModal && (
            <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[60] p-4 animate-fade-in">
              <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-elevated border border-gray-100 animate-fade-in-scale">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 px-4 py-2 bg-gradient-to-r from-primary-500 to-accent-indigo text-white rounded-xl hover:from-primary-600 hover:to-primary-700 shadow-md shadow-primary-500/20 hover:shadow-lg transition-all duration-200"
                    >
                      Change Password
                    </button>
                    <button
